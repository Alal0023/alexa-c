...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Design Refine builds a professional landing page for a senior design lead, incorporating user feedback and design system elements." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Design Refine builds a professional landing page for a senior design lead, incorporating user feedback and design system elements." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Design Refine builds a professional landing page for a senior design lead, incorporating user feedback and design system elements." },
